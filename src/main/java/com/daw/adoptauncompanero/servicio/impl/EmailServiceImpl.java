...
// Implementa las notificaciones automáticas de la lógica de
// negocio (2.2.5 / 2.4.7).
// =============================================================
@Service
public class EmailServiceImpl implements EmailService {
    ...
    public void enviarEmailHtml(String para, String asunto, String htmlCuerpo) {
        try {
            ...
            helper.setText(htmlCuerpo, true);  // true = es HTML
            mailSender.send(mensaje);
    ...
    // ---------- 3. Email de cambio de estado (2.2.5 / 2.4.7) ----------
    @Override
    public void notificarCambioEstadoSolicitud(String para, String nombreUsuario,
        ...
        String html = """
            ...
            """.formatted(nombreUsuario, nombreAnimal,
                          estadoAnterior == null ? "INICIO" : estadoAnterior,
                          estadoNuevo,
    ...
    // ---------- 4. Email de cita programada (2.2.4.4) ----------
    @Override
    public void notificarCitaProgramada(String para, String nombreUsuario, String nombreAnimal,
        ...
        String html = """
            ...
            """.formatted(nombreUsuario, nombreAnimal, fechaCita,
