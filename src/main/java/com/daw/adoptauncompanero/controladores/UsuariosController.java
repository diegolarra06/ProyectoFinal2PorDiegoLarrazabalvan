...
//  - 2.3.3 Área personal (cliente registrado)
//  - 2.2.4.6 Gestión de usuarios (admin)
// =============================================================
@Controller
...
public class UsuariosController {
    ...
    // -------------------------
    // 2.3.3 - ÁREA PERSONAL del cliente
    // -------------------------
    ...
    public String actualizarDatos(@RequestParam Integer id,
    ...
    @PostMapping("/listado")
    public String listadoPost(@RequestParam(required = false) Integer id,
