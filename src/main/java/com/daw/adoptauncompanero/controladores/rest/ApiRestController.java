...
public class ApiRestController {
    ...
    public ResponseEntity<List<AnimalDTO>> buscar(
        ...
        return ResponseEntity.ok(animalService.buscarAnimales(
                null, nombre, especie, edadMin, edadMax, tamano, estado));
    }
    ...
    public ResponseEntity<Map<String, Object>> obtenerAnimal(@PathVariable Integer id) {
        ...
        List<Map<String, Object>> imgs = a.getImagenes() == null ? List.of()
    ...
    public ResponseEntity<Integer> crear(@RequestBody Map<String, Object> body) {
        Integer id = animalService.insertarAnimal(
                ...
                (String) body.get("personalidad"),
                (String) body.get("necesidadesEspeciales"),
                (String) body.get("estadoSanitario"),
    ...
    public ResponseEntity<Integer> actualizar(@PathVariable Integer id,
                                              @RequestBody Map<String, Object> body) {
        Integer res = animalService.actualizarAnimal(id,
                (String) body.get("nombre"),
                (String) body.get("especie"),
                (Integer) body.get("edad"),
                (String) body.get("tamano"),
    ...
    public ResponseEntity<Map<String, Object>> miSesion(Principal principal) {
        ...
        if (u == null) return ResponseEntity.ok(Map.of("autenticado", false));
    ...
    public ResponseEntity<Integer> iniciar(@RequestBody Map<String, Object> body, Principal principal) {
        UsuarioEntity u = usuarioService.obtenerPorEmail(principal.getName());
        Integer res = solicitudService.iniciarSolicitud(
                u.getIdUsuario(),
                (Integer) body.get("idAnimal"),
                (String) body.get("comentarios"));
        return ResponseEntity.ok(res);
    }
    ...
    public ResponseEntity<Integer> cambiarEstado(@PathVariable Integer id,
                                                 @RequestBody Map<String, Object> body) {
        return ResponseEntity.ok(solicitudService.cambiarEstado(
                id,
                (Integer) body.get("idEstadoNuevo"),
    ...
    public ResponseEntity<Integer> actualizarMisDatos(@PathVariable Integer id,
                                                      @RequestBody Map<String, Object> body) {
        return ResponseEntity.ok(usuarioService.actualizarDatosPersonales(id,
                (String) body.get("nombre"),
    ...
    public ResponseEntity<Integer> programarCita(@RequestBody Map<String, Object> body) {
        return ResponseEntity.ok(citaService.programarCita(
                (Integer) body.get("idSolicitud"),
                java.time.LocalDateTime.parse((String) body.get("fechaCita")),
