...
//  - 2.3.1 Catálogo (público)
//  - 2.3.2 Ficha del animal (público)
//  - 2.2.4.1 CRUD de animales (admin)
//  - 2.3.2.1 Subida de imágenes (admin) - PDF 6.2
// =============================================================
@Controller
...
public class AnimalesController {
    ...
    public String catalogoGet(Model model) {
        // Listamos sin filtros al entrar
    ...
    public String catalogoPost(@RequestParam(required = false) String nombre,
        ...
        // 2.3.1.5 a 2.3.1.9 - filtros del catálogo
    ...
    // -------------------------
    // 2.2.4.1 - LISTADO PARA ACTUALIZAR (admin)
    // -------------------------
    ...
    public String actualizarPost(@RequestParam Integer id,
        ...
        Integer res = animalService.actualizarAnimal(id, nombre, especie, edad, tamano,
                                                     personalidad, necesidadesEspeciales,
    ...
    // -------------------------
    // 2.3.2.1 - SUBIR IMAGEN (admin) - PDF 6.2
    // -------------------------
